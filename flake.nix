{
  ...
  inputs = {
    ...
    rravalNixPrivate = { url = "github:rraval/nix-private"; };
    homeManager = {
  ...
  outputs =
    { self, nixpkgs, rravalNixPrivate, homeManager, gitNomad, encircle, }:
    let
      boxModule = { imports = [ homeManager.nixosModule ./box ]; };
      ...
      nixosConfigurations = mkAllHosts {
        apollo = { pkgs, lib, ... }: {
          box.disks = {
            decrypted0 = {
              encryptedDevice =
                "/dev/disk/by-uuid/270f43d6-38dd-4f81-b155-fe20fece7a38";
              isSolidState = true;
            };
            decrypted1 = {
              encryptedDevice =
                "/dev/disk/by-uuid/532bf1c6-a46a-48a8-acaa-1d4764ea63d3";
              isSolidState = true;
            };
          };
        ...
        boreas = { pkgs, lib, ... }: {
          box.disks = {
            decrypted0 = {
              encryptedDevice =
                "/dev/disk/by-uuid/c6bf32b5-0cb2-4e5b-bdce-9725edb726d0";
              isSolidState = true;
            };
          };
        ...
        clio = { pkgs, lib, ... }: {
          box.disks = {
            decrypted0 = {
              encryptedDevice =
                "/dev/disk/by-uuid/aeb64845-315b-4c27-9a20-edbe5b4dc8da";
              isSolidState = true;
            };
          };
