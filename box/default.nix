{ nixpkgs, home-manager }: {
  /*
    # Unique name for the machine being configured.
    hostName :: String
  */
  hostName,

  /*
    # LUKS encrypted disk that holds LVM physical volumes, volume groups, and
    # logical volumes inside it.
    rootDevice :: {
      # Something like `"/dev/disk/by-uuid/..."`.
      encryptedDisk :: String,
  ...
  */
  ...
  /*
    # Additional NixOS modules to include in the configuration, like the
    # `hardware-configuration.nix` that `nixos-generate-config` will generate.
      ...
      in mkMerge [
        {
          ...
          boot = {
            ...
            initrd.luks.devices = {
              decrypted0 = {
                device = rootDevice.encryptedDisk;
                preLVM = true;
